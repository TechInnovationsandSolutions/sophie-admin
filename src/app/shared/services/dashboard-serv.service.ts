...
export class DashboardServService {
  ...
  makeThumbnail(response: any) {
    ...
    const thumbnail =
      response.eager && response.eager[0].secure_url
        ? response.eager[0].secure_url
        : response.secure_url.split("upload/").join("upload/c_scale,w_150/");
    return thumbnail;
  }
    ...
    return new Promise((resolve) => {
      this.http
        ...
        .subscribe((resp) => {
          ...
          this.http
            .put<any>(
              this._url + "categories/" + category.id,
              {
                name: category.name,
                picture: {
                  url: response.secure_url,
  ...
  checkIfCategoryhasProducts(id) {
    return new Promise((resolve) => {
      this.http
        .get<any>(this._url + "categories/" + id + "/products", {
  ...
  deleteCategory(id: string) {
    return new Promise((resolve) => {
      const token = this.getToken();
      this.http
        .delete<any>(this._url + "categories/" + id, {
  ...
  getProductsByCategory(catid: number, param: string) {
    return new Promise((resolve) => {
      this.http
        .get<any>(this._url + "categories/" + catid + "/products", {
          params: new HttpParams().set("page", param),
        })
        .subscribe(
          (res) => {
  ...
  getProductsByTag(tagName: string) {
    return new Promise((resolve) => {
      this.http
        .post<any>(this._url + "products/tags", {
          tag: tagName,
        })
        .subscribe(
          (res) => {
      ...
      this.http
        .put<any>(
          this._url + "products/" + product.id,
          {
            ...
            excerpts: product.excerpt,
            cost: product.cost,
            discount: +product.discount.substring(
              0,
  ...
  deleteProduct(id) {
    return new Promise((resolve, reject) => {
      const token = this.getToken();
      this.http
        .delete<any>(this._url + "products/" + id, {
          headers: new HttpHeaders().set("Authorization", `Bearer ${token}`),
        })
        .subscribe(
          (res) => {
  ...
  deleteTag(tagId: number) {
    return new Promise((resolve) => {
      const token = this.getToken();
      this.http
        .delete<any>(this._url + "tags/" + tagId, {
          headers: new HttpHeaders().set("Authorization", `Bearer ${token}`),
        })
        .subscribe(
          (res) => {
  ...
  getUserOrders(userId: number | string) {
    return new Promise((resolve) => {
      const token = this.getToken();
      this.http
        .get<any>(this._url + "users/" + userId + "/orders", {
          headers: new HttpHeaders().set("Authorization", `Bearer ${token}`),
        })
        .subscribe(
          (res) => {
